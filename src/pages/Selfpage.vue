    ...
    <div id="selfpage">
        ...
        <div class="self-info clearfix">
            ...
            <div class="rightWriter fr">
                <nuxt-link to="/editprofile">编辑资料</nuxt-link>
            </div>
        </div>
        ...
        <div class="myActive">
            <div class="self_con">
                <div class="self_items clearfix"
                     v-for="(item,index) in selfComment">
                    <img src="../assets/imgs/head.jpg"
                         alt=""
                         class="fl self_head">
                    <div class="rightInfo">
                        <p class="self_name">{{item.media_name}}</p>
...
export default {
    ...
    async asyncData ({ $axios }) {
        const { ok, selfCommentData } = await $axios.$get(`/api/self-comment`)
        if (ok) {
            return {
                selfComment: selfCommentData.data
            }
        }
    },
    methods: {
